...
data ContFromAnyWT st bef aft a b
  ...
  = ContFromAnyWT ((forall i. KnownMaybeBool i => IndexReachableT i aft -> a -> InterT st i aft b) -> InterT st bef aft b)
...
dispatchSomeWT :: ContFromAnyWT st bef aft a b
                -> (forall i. KnownMaybeBool i => IndexReachableT i aft -> a -> InterT st i aft b)
                -> InterT st bef aft b
